<template>
  <div>
    ...
    <p>
      ...
      <a href="https://reactjs.org/docs/portals.html/" target="_blank" rel="noopener">React portals</a>
    ...
    <div class="example-container">
      <div>
        <h4>With portal</h4>
        <kup-fld :config.prop="fldConfig" :data.prop="fldData" class="hide-overflow" />
        <p>
      ...
      <div>
        ...
        <kup-fld class="hide-overflow" :config.prop="fldConfigNoPortal" :data.prop="fldData" />
        <p>
