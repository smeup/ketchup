<template>
  <div>
    <div class="demo-wrapper">
      The drawer component also has 2 useful props,<div color="red">
        Right and Permanent.</div
      >
      <br />
      <br />

      <p class="centered"
        >adding the right attribute to our component for example we will have
        this result</p
      >
      ...
      <p>
        Similarly to right, the "permanent" Prop can be added which can be used
        combined with "right" or without "right". The "permanent" makes sure
        that our drawer always remains fixed without disappearing when we click
        out of it.
      </p>
      <br />
      <p class="centered">example of use:</p>
      <code align="center" class="flat"
        >{{ markupBasic8 }}<br />or<br />{{ markupBasic9 }}<br
      /></code>
      <br />
    </div>
  </div>
