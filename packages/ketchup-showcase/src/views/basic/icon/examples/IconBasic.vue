  ...
  <div>
    <div class="demo-wrapper">
      <p>
        ...
        <span
          class="code-word"
        >assets</span> folder which must be placed in
        your app's root directory, this way the component will be able to fetch
        the files correctly. You can add your own files to it, just be sure to
        put them inside folders named as the files' extension.
        <br />
        <br />I.E:
        <span class="code-word">assets/YOUR_FILE_EXTENSION/YOUR_FILE.YOUR_FILE_EXTENSION</span>
        <br />
        <br />Once you're done with the setup of the assets, all you need
        to do to render the image you want is setting the
        <span
          class="code-word"
        >name</span> prop with your file's name and
        setting the
        <span class="code-word">type</span> prop with your file's
        extension.
      </p>
