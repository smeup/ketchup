<template>
  <div>
    <div class="demo-wrapper">
      <p>
        <span class="code-word"
          >draggable(el, options?, eventData?, effect?, callbacks?): void</span
        ><br />
        Method used to setup a new draggable element. An element being drag will
        have the attribute <span class="code-word">kup-draggable</span> for
        additional styling options.<br /><br />
        - <strong>el (HTMLElement)</strong> - The draggable element.<br />
        - <strong>options (Partial&lt;DraggableOptions&gt;)</strong> - Options
        of the draggable element. Check
    ...
    <p>
      ...
      ><br />
      Method used to setup a new dropzone. A dropzone will have the attribute
      <span class="code-word">kup-drag-over</span> for additional styling
      options when a <span class="code-word">kup-draggable</span> is moved over
      it.<br /><br />
      - <strong>el (HTMLElement)</strong> - The dropzone element.<br />
      - <strong>options (Partial&lt;DropzoneOptions&gt;)</strong> - Options of
      the dropzone. Check
      <a href="https://interactjs.io/docs/action-options/"
        >the official Interactjs documentation</a
      >
      to learn more. <br />- <strong>eventData (KupDropEventData)</strong> -
      Argument used to transfer data for the drop event. The callback is used to
      return information of the receiving item - such as cell, column and row
      info. <br />- <strong>callbacks (KupDropCallbacks)</strong> - Additional
      callbacks to invoke.<br /><br />
    </p>
    <div class="demo-container">
      <div id="dropzone" class="interact-example"><div>Dropzone</div></div>
    </div>
    <p>
      <span class="code-word">
      ...
      - <strong>options (Partial&lt;ResizableOptions&gt;)</strong> - Options of
      the resize action. Check
      <a href="https://interactjs.io/docs/action-options/"
        >the official Interactjs documentation</a
      >
      to learn more. <br />- <strong>callbacks (KupResizeCallbacks)</strong> -
      Additional callbacks to invoke. <br />-
      <strong>moveOnResize (boolean)</strong> - When true, the element will be
      moved when resizing in order to keep its position. <br />-
      <strong>autoResize (boolean)</strong> - When true, the element will be
      automatically resized (usually the behavior is specified in a
      callback).<br /><br />
    </p>
    <div class="demo-container">
      <div id="resize-me" class="interact-example"><div>Resize me</div></div>
    </div>
    <p>
      <span class="code-word">on(el, event, callback): void</span><br />
      Adds a new interact.js event listener to the given argument. Available
      events are <span class="code-word">doubletap</span>,
      ...
      - <strong>event (KupPointerEventTypes)</strong> - Name of the event.<br />-
      <strong>callback (KupResizeCallbacks)</strong> - Callback to invoke when
      the event fires.<br /><br />
    </p>
    <div class="demo-container">
      <div id="event-tester" class="interact-example"></div>
    </div>
    <p>
    ...
    <p>
      ...
      - <strong>elements (HTMLElement[])</strong> - Elements to handle.<br />
    </p>
    <p>
      <span class="code-word"
        >dialogify(el, handleEl?, unresizable?, restrictContainer?): void</span
      ><br />
      This method gives the element dialog-like features, by activating moving
      on drag and, optionally, the resize.<br /><br />
      - <strong>el (HTMLElement)</strong> - Dialog element.<br />
      - <strong>handleEl (HTMLElement)</strong> - Element that must be dragged
      in order to trigger movement. When not provided, dragging anywhere on
      <span class="code-word">el</span> will move it.<br />-
      <strong>unresizable (boolean)</strong> - When true, the dialog can't be
      resized.<br />- <strong>restrictContainer (RectResolvable)</strong> - When
      present, it will set the constraint of <span class="code-word">el</span>:
      it can't be moved outside this container.<br /><br />
    </p>
    <div class="demo-container">
      <div class="kup-container">
        <div id="dialog"
...
export default {
  ...
  methods: {
    ...
    initWidgets(): void {
      ...
      dom.ketchup.interact.dropzone(dropzone);
