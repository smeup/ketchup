<template>
  <div>
    <comp :giturl="giturl" :headtitle="headtitle" :titles="titles">
      <template v-slot:0>
        <kup-interact-basic></kup-interact-basic>
      </template>
      <template v-slot:1>
        <kup-interact-features></kup-interact-features>
      </template>
      <template v-slot:2>
        <kup-interact-events></kup-interact-events>
      </template>
    </comp>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      giturl:
        'https://github.com/smeup/ketchup/tree/develop/packages/ketchup/src/utils/kup-interact',
      headtitle: 'KupInteract',
      titles: ['What is it?', 'Features', 'Events'],
    };
  },
  title: 'Ketchup | KupInteract',
};
</script>
