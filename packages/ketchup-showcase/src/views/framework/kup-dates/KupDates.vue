<template>
  <div>
    <comp :giturl="giturl" :headtitle="headtitle" :titles="titles">
      <template v-slot:0>
        <kup-dates-basic></kup-dates-basic>
      </template>
      <template v-slot:1>
        <kup-dates-features></kup-dates-features>
      </template>
      <template v-slot:2>
        <kup-dates-events></kup-dates-events>
      </template>
    </comp>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      giturl:
        'https://github.com/smeup/ketchup/tree/develop/packages/ketchup/src/utils/kup-dates',
      headtitle: 'KupDates',
