<template>
  <div>
    <div class="demo-wrapper">
      <p>
        Cards can also be displayed as context menus or as tooltips by setting the
        <span
          class="code-word"
        >isMenu</span> prop to true. Considering the nature of this layout, which is usually displayed after an interface action, by default it is hidden.
      ...
      <div class="demo-container">
        <div class="kup-container">
          <kup-card size-x="300px" size-y="300px" is-menu menu-visible :data.prop="data"></kup-card>
        </div>
