import { KulLanguageJSON } from './kul-language-declarations';

export const languagesJson: KulLanguageJSON = {
    chinese: {
        keys: {
            checkboxAll: '全部',
            checkboxChecked: '已检查',
    ...
    english: {
        keys: {
            ...
            columnNonNumericalInTable:
                'No numerical columns exist in this table.',
    ...
    french: {
        keys: {
            ...
            columnNonNumericalInTable:
                "Aucune colonne numérique n'existe dans ce tableau.",
            ...
            genericLayoutNotYetImplemented:
                'Mise en page pas encore implémentée',
            genericList: 'Lister',
    ...
    italian: {
        keys: {
            ...
            columnNoFormula:
                'Non ci sono formule disponibili per queste colonne.',
            columnNonNumerical: 'Queste colonne non sono numeriche.',
            columnNonNumericalInTable:
                'Non esistono colonne numeriche in questa tabella.',
        ...
        variants: {
            smeup: {
                keys: {
                    columnNonNumericalInTable:
                        'Non esistono colonne numeriche in questa matrice.',
    ...
    polish: {
        keys: {
            ...
            genericLayoutNotYetImplemented:
                'Układ nie został jeszcze zaimplementowany',
            genericList: 'Lista',
    ...
    russian: {
        keys: {
            ...
            genericShowTooltipInfo:
                'Показать информацию во всплывающей подсказке',
    ...
    spanish: {
        keys: {
            ...
            columnNonNumericalInTable:
                'No existen columnas numéricas en esta tabla.',
            ...
            genericShowTooltipInfo:
                'Mostrar información de información sobre herramientas',
