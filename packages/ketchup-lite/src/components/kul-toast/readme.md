...
| ------------------ | ------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `kulCloseCallback` | --            | Callback invoked when the toast is closed.                                                                  | `() => void`             | `() => {         const e = new CustomEvent('unmount');         this.onKulEvent(e, 'unmount');         this.kulEvent.emit({             comp: this,             eventType: 'unmount',             id: this.rootElement.id,             originalEvent: e,         });         this.rootElement.remove();     }` |
