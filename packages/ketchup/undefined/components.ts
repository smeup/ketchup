...
import { type KupAccordionCustomEvent, type KupAccordionItemSelectedEventPayload, type KupAutocompleteCustomEvent, type KupAutocompleteEventPayload, type KupAutocompleteIconClickEventPayload, type KupBadgeCustomEvent, type KupBoxAutoSelectEventPayload, type KupBoxClickEventPayload, type KupBoxContextMenuEventPayload, type KupBoxCustomEvent, type KupBoxLoadMoreClickEventPayload, type KupBoxRowActionClickEventPayload, type KupBoxSelectedEventPayload, type KupButtonClickEventPayload, type KupButtonCustomEvent, type KupButtonListClickEventPayload, type KupButtonListCustomEvent, type KupCalendarCustomEvent, type KupCalendarDateClickEventPayload, type KupCalendarEventClickEventPayload, type KupCalendarEventDropEventPayload, type KupCalendarViewChangeEventPayload, type KupCardClickPayload, type KupCardCustomEvent, type KupCardEventPayload, type KupCardListClickEventPayload, type KupCardListCustomEvent, type KupChartClickEvent, type KupChartCustomEvent, type KupCheckboxCustomEvent, type KupCheckboxEventPayload, type KupChipChangeEventPayload, type KupChipCustomEvent, type KupChipEventPayload, type KupColorPickerCustomEvent, type KupColorPickerEventPayload, type KupComboboxCustomEvent, type KupComboboxEventPayload, type KupComboboxIconClickEventPayload, type KupDashboardCustomEvent, type KupDashboardEventPayload, type KupDataTableCustomEvent, type KupDatatableClickEventPayload, type KupDatatableColumnMenuEventPayload, type KupDatatableColumnMoveEventPayload, type KupDatatableColumnRemoveEventPayload, type KupDatatableDeleteRowEventPayload, type KupDatatableHistoryEventPayload, type KupDatatableInsertRowEventPayload, type KupDatatableLoadMoreClickEventPayload, type KupDatatableRowActionClickEventPayload, type KupDatatableRowActionItemClickEventPayload, type KupDatatableRowSelectedEventPayload, type KupDatePickerCustomEvent, type KupDatePickerEventPayload, type KupDialogCustomEvent, type KupDrawerCustomEvent, type KupDropdownButtonCustomEvent, type KupDropdownButtonEventPayload, type KupEchartClickEventPayload, type KupEchartCustomEvent, type KupEditorCustomEvent, type KupEditorEventPayload, type KupEventPayload, type KupFamilyTreeCustomEvent, type KupFamilyTreeEventPayload, type KupFormCustomEvent, type KupIframeCustomEvent, type KupImageClickEventPayload, type KupImageCustomEvent, type KupImageListCustomEvent, type KupImageListEventPayload, type KupInputPanelCustomEvent, type KupLazyCustomEvent, type KupListCustomEvent, type KupListEventPayload, type KupNavBarCustomEvent, type KupNumericPickerCustomEvent, type KupNumericPickerEventPayload, type KupPdfCustomEvent, type KupPhotoFrameCustomEvent, type KupPlannerClickEventPayload, type KupPlannerCustomEvent, type KupPlannerEventPayload, type KupPlannerUnloadEventPayload, type KupRadioChangeEventPayload, type KupRadioCustomEvent, type KupRatingClickEventPayload, type KupRatingCustomEvent, type KupSnackbarCustomEvent, type KupSpinnerCustomEvent, type KupSwitchCustomEvent, type KupSwitchEventPayload, type KupTabBarCustomEvent, type KupTabBarEventPayload, type KupTextFieldCustomEvent, type KupTextFieldEventPayload, type KupTimePickerCustomEvent, type KupTimePickerEventPayload, type KupTreeColumnMenuEventPayload, type KupTreeColumnRemoveEventPayload, type KupTreeContextMenuEventPayload, type KupTreeCustomEvent, type KupTreeDynamicMassExpansionEventPayload, type KupTreeNodeButtonClickEventPayload, type KupTreeNodeCollapseEventPayload, type KupTreeNodeExpandEventPayload, type KupTreeNodeSelectedEventPayload } from "@sme.up/ketchup";
import { KupAccordion as KupAccordionElement, defineCustomElement as defineKupAccordion } from "@sme.up/ketchup/components/kup-accordion.js";
import { KupAutocomplete as KupAutocompleteElement, defineCustomElement as defineKupAutocomplete } from "@sme.up/ketchup/components/kup-autocomplete.js";
import { KupBadge as KupBadgeElement, defineCustomElement as defineKupBadge } from "@sme.up/ketchup/components/kup-badge.js";
import { KupBox as KupBoxElement, defineCustomElement as defineKupBox } from "@sme.up/ketchup/components/kup-box.js";
import { KupButtonList as KupButtonListElement, defineCustomElement as defineKupButtonList } from "@sme.up/ketchup/components/kup-button-list.js";
import { KupButton as KupButtonElement, defineCustomElement as defineKupButton } from "@sme.up/ketchup/components/kup-button.js";
import { KupCalendar as KupCalendarElement, defineCustomElement as defineKupCalendar } from "@sme.up/ketchup/components/kup-calendar.js";
import { KupCardList as KupCardListElement, defineCustomElement as defineKupCardList } from "@sme.up/ketchup/components/kup-card-list.js";
import { KupCard as KupCardElement, defineCustomElement as defineKupCard } from "@sme.up/ketchup/components/kup-card.js";
import { KupCell as KupCellElement, defineCustomElement as defineKupCell } from "@sme.up/ketchup/components/kup-cell.js";
import { KupChart as KupChartElement, defineCustomElement as defineKupChart } from "@sme.up/ketchup/components/kup-chart.js";
import { KupCheckbox as KupCheckboxElement, defineCustomElement as defineKupCheckbox } from "@sme.up/ketchup/components/kup-checkbox.js";
import { KupChip as KupChipElement, defineCustomElement as defineKupChip } from "@sme.up/ketchup/components/kup-chip.js";
import { KupColorPicker as KupColorPickerElement, defineCustomElement as defineKupColorPicker } from "@sme.up/ketchup/components/kup-color-picker.js";
import { KupCombobox as KupComboboxElement, defineCustomElement as defineKupCombobox } from "@sme.up/ketchup/components/kup-combobox.js";
import { KupCustomTaskListHeader as KupCustomTaskListHeaderElement, defineCustomElement as defineKupCustomTaskListHeader } from "@sme.up/ketchup/components/kup-custom-task-list-header.js";
import { KupCustomTaskListTable as KupCustomTaskListTableElement, defineCustomElement as defineKupCustomTaskListTable } from "@sme.up/ketchup/components/kup-custom-task-list-table.js";
import { KupDashboard as KupDashboardElement, defineCustomElement as defineKupDashboard } from "@sme.up/ketchup/components/kup-dashboard.js";
import { KupDataTable as KupDataTableElement, defineCustomElement as defineKupDataTable } from "@sme.up/ketchup/components/kup-data-table.js";
import { KupDatePicker as KupDatePickerElement, defineCustomElement as defineKupDatePicker } from "@sme.up/ketchup/components/kup-date-picker.js";
import { KupDialog as KupDialogElement, defineCustomElement as defineKupDialog } from "@sme.up/ketchup/components/kup-dialog.js";
import { KupDrawer as KupDrawerElement, defineCustomElement as defineKupDrawer } from "@sme.up/ketchup/components/kup-drawer.js";
import { KupDropdownButton as KupDropdownButtonElement, defineCustomElement as defineKupDropdownButton } from "@sme.up/ketchup/components/kup-dropdown-button.js";
import { KupEchart as KupEchartElement, defineCustomElement as defineKupEchart } from "@sme.up/ketchup/components/kup-echart.js";
import { KupEditor as KupEditorElement, defineCustomElement as defineKupEditor } from "@sme.up/ketchup/components/kup-editor.js";
import { KupFamilyTree as KupFamilyTreeElement, defineCustomElement as defineKupFamilyTree } from "@sme.up/ketchup/components/kup-family-tree.js";
import { KupForm as KupFormElement, defineCustomElement as defineKupForm } from "@sme.up/ketchup/components/kup-form.js";
import { KupGanttCalendar as KupGanttCalendarElement, defineCustomElement as defineKupGanttCalendar } from "@sme.up/ketchup/components/kup-gantt-calendar.js";
import { KupGantt as KupGanttElement, defineCustomElement as defineKupGantt } from "@sme.up/ketchup/components/kup-gantt.js";
import { KupGauge as KupGaugeElement, defineCustomElement as defineKupGauge } from "@sme.up/ketchup/components/kup-gauge.js";
import { KupGridRenderer as KupGridRendererElement, defineCustomElement as defineKupGridRenderer } from "@sme.up/ketchup/components/kup-grid-renderer.js";
import { KupGrid as KupGridElement, defineCustomElement as defineKupGrid } from "@sme.up/ketchup/components/kup-grid.js";
import { KupHorizontalScroll as KupHorizontalScrollElement, defineCustomElement as defineKupHorizontalScroll } from "@sme.up/ketchup/components/kup-horizontal-scroll.js";
import { KupIframe as KupIframeElement, defineCustomElement as defineKupIframe } from "@sme.up/ketchup/components/kup-iframe.js";
import { KupImageList as KupImageListElement, defineCustomElement as defineKupImageList } from "@sme.up/ketchup/components/kup-image-list.js";
import { KupImage as KupImageElement, defineCustomElement as defineKupImage } from "@sme.up/ketchup/components/kup-image.js";
import { KupInputPanel as KupInputPanelElement, defineCustomElement as defineKupInputPanel } from "@sme.up/ketchup/components/kup-input-panel.js";
import { KupLazy as KupLazyElement, defineCustomElement as defineKupLazy } from "@sme.up/ketchup/components/kup-lazy.js";
import { KupList as KupListElement, defineCustomElement as defineKupList } from "@sme.up/ketchup/components/kup-list.js";
import { KupMagicBox as KupMagicBoxElement, defineCustomElement as defineKupMagicBox } from "@sme.up/ketchup/components/kup-magic-box.js";
import { KupNavBar as KupNavBarElement, defineCustomElement as defineKupNavBar } from "@sme.up/ketchup/components/kup-nav-bar.js";
import { KupNumericPicker as KupNumericPickerElement, defineCustomElement as defineKupNumericPicker } from "@sme.up/ketchup/components/kup-numeric-picker.js";
import { KupPdf as KupPdfElement, defineCustomElement as defineKupPdf } from "@sme.up/ketchup/components/kup-pdf.js";
import { KupPhotoFrame as KupPhotoFrameElement, defineCustomElement as defineKupPhotoFrame } from "@sme.up/ketchup/components/kup-photo-frame.js";
import { KupPlannerRenderer as KupPlannerRendererElement, defineCustomElement as defineKupPlannerRenderer } from "@sme.up/ketchup/components/kup-planner-renderer.js";
import { KupPlanner as KupPlannerElement, defineCustomElement as defineKupPlanner } from "@sme.up/ketchup/components/kup-planner.js";
import { KupProbe as KupProbeElement, defineCustomElement as defineKupProbe } from "@sme.up/ketchup/components/kup-probe.js";
import { KupProgressBar as KupProgressBarElement, defineCustomElement as defineKupProgressBar } from "@sme.up/ketchup/components/kup-progress-bar.js";
import { KupQlik as KupQlikElement, defineCustomElement as defineKupQlik } from "@sme.up/ketchup/components/kup-qlik.js";
import { KupRadio as KupRadioElement, defineCustomElement as defineKupRadio } from "@sme.up/ketchup/components/kup-radio.js";
import { KupRating as KupRatingElement, defineCustomElement as defineKupRating } from "@sme.up/ketchup/components/kup-rating.js";
import { KupSnackbar as KupSnackbarElement, defineCustomElement as defineKupSnackbar } from "@sme.up/ketchup/components/kup-snackbar.js";
import { KupSpinner as KupSpinnerElement, defineCustomElement as defineKupSpinner } from "@sme.up/ketchup/components/kup-spinner.js";
import { KupStandardTooltip as KupStandardTooltipElement, defineCustomElement as defineKupStandardTooltip } from "@sme.up/ketchup/components/kup-standard-tooltip.js";
import { KupSwitch as KupSwitchElement, defineCustomElement as defineKupSwitch } from "@sme.up/ketchup/components/kup-switch.js";
import { KupSwitcher as KupSwitcherElement, defineCustomElement as defineKupSwitcher } from "@sme.up/ketchup/components/kup-switcher.js";
import { KupTabBar as KupTabBarElement, defineCustomElement as defineKupTabBar } from "@sme.up/ketchup/components/kup-tab-bar.js";
import { KupTaskGantt as KupTaskGanttElement, defineCustomElement as defineKupTaskGantt } from "@sme.up/ketchup/components/kup-task-gantt.js";
import { KupTaskListHeader as KupTaskListHeaderElement, defineCustomElement as defineKupTaskListHeader } from "@sme.up/ketchup/components/kup-task-list-header.js";
import { KupTaskListTable as KupTaskListTableElement, defineCustomElement as defineKupTaskListTable } from "@sme.up/ketchup/components/kup-task-list-table.js";
import { KupTaskList as KupTaskListElement, defineCustomElement as defineKupTaskList } from "@sme.up/ketchup/components/kup-task-list.js";
import { KupTextField as KupTextFieldElement, defineCustomElement as defineKupTextField } from "@sme.up/ketchup/components/kup-text-field.js";
import { KupTimePicker as KupTimePickerElement, defineCustomElement as defineKupTimePicker } from "@sme.up/ketchup/components/kup-time-picker.js";
import { KupTooltip as KupTooltipElement, defineCustomElement as defineKupTooltip } from "@sme.up/ketchup/components/kup-tooltip.js";
import { KupTree as KupTreeElement, defineCustomElement as defineKupTree } from "@sme.up/ketchup/components/kup-tree.js";
import { KupVerticalScroll as KupVerticalScrollElement, defineCustomElement as defineKupVerticalScroll } from "@sme.up/ketchup/components/kup-vertical-scroll.js";
...
export const KupAccordion = /*@__PURE__*/ createComponent<KupAccordionElement, KupAccordionEvents>({
...
export const KupAutocomplete = /*@__PURE__*/ createComponent<KupAutocompleteElement, KupAutocompleteEvents>({
...
export const KupBadge = /*@__PURE__*/ createComponent<KupBadgeElement, KupBadgeEvents>({
    tagName: 'kup-badge',
...
export const KupBox = /*@__PURE__*/ createComponent<KupBoxElement, KupBoxEvents>({
    tagName: 'kup-box',
...
export const KupButton = /*@__PURE__*/ createComponent<KupButtonElement, KupButtonEvents>({
    tagName: 'kup-button',
...
export const KupButtonList = /*@__PURE__*/ createComponent<KupButtonListElement, KupButtonListEvents>({
...
export const KupCalendar = /*@__PURE__*/ createComponent<KupCalendarElement, KupCalendarEvents>({
...
export const KupCard = /*@__PURE__*/ createComponent<KupCardElement, KupCardEvents>({
    tagName: 'kup-card',
...
export const KupCardList = /*@__PURE__*/ createComponent<KupCardListElement, KupCardListEvents>({
...
type KupCellEvents = NonNullable<unknown>;

export const KupCell = /*@__PURE__*/ createComponent<KupCellElement, KupCellEvents>({
    tagName: 'kup-cell',
    elementClass: KupCellElement,
    react: React,
    events: {} as KupCellEvents,
    defineCustomElement: defineKupCell
});

type KupChartEvents = { onKupChartClick: EventName<KupChartCustomEvent<KupChartClickEvent>> };

export const KupChart = /*@__PURE__*/ createComponent<KupChartElement, KupChartEvents>({
    tagName: 'kup-chart',
...
export const KupCheckbox = /*@__PURE__*/ createComponent<KupCheckboxElement, KupCheckboxEvents>({
...
export const KupChip = /*@__PURE__*/ createComponent<KupChipElement, KupChipEvents>({
    tagName: 'kup-chip',
...
export const KupColorPicker = /*@__PURE__*/ createComponent<KupColorPickerElement, KupColorPickerEvents>({
...
export const KupCombobox = /*@__PURE__*/ createComponent<KupComboboxElement, KupComboboxEvents>({
...
export const KupCustomTaskListHeader = /*@__PURE__*/ createComponent<KupCustomTaskListHeaderElement, KupCustomTaskListHeaderEvents>({
...
export const KupCustomTaskListTable = /*@__PURE__*/ createComponent<KupCustomTaskListTableElement, KupCustomTaskListTableEvents>({
...
export const KupDashboard = /*@__PURE__*/ createComponent<KupDashboardElement, KupDashboardEvents>({
...
type KupDataTableEvents = {
    ...
    onKupDatatableRowactionclick: EventName<KupDataTableCustomEvent<KupDatatableRowActionClickEventPayload>>,
...
export const KupDataTable = /*@__PURE__*/ createComponent<KupDataTableElement, KupDataTableEvents>({
    ...
    events: {
        ...
        onKupDatatableRowactionclick: 'kup-datatable-rowactionclick',
...
export const KupDatePicker = /*@__PURE__*/ createComponent<KupDatePickerElement, KupDatePickerEvents>({
...
export const KupDialog = /*@__PURE__*/ createComponent<KupDialogElement, KupDialogEvents>({
    tagName: 'kup-dialog',
...
export const KupDrawer = /*@__PURE__*/ createComponent<KupDrawerElement, KupDrawerEvents>({
    tagName: 'kup-drawer',
...
export const KupDropdownButton = /*@__PURE__*/ createComponent<KupDropdownButtonElement, KupDropdownButtonEvents>({
...
export const KupEchart = /*@__PURE__*/ createComponent<KupEchartElement, KupEchartEvents>({
    tagName: 'kup-echart',
...
export const KupEditor = /*@__PURE__*/ createComponent<KupEditorElement, KupEditorEvents>({
    tagName: 'kup-editor',
...
export const KupFamilyTree = /*@__PURE__*/ createComponent<KupFamilyTreeElement, KupFamilyTreeEvents>({
...
export const KupForm = /*@__PURE__*/ createComponent<KupFormElement, KupFormEvents>({
    tagName: 'kup-form',
...
export const KupGantt = /*@__PURE__*/ createComponent<KupGanttElement, KupGanttEvents>({
    tagName: 'kup-gantt',
...
export const KupGanttCalendar = /*@__PURE__*/ createComponent<KupGanttCalendarElement, KupGanttCalendarEvents>({
...
export const KupGauge = /*@__PURE__*/ createComponent<KupGaugeElement, KupGaugeEvents>({
    tagName: 'kup-gauge',
...
export const KupGrid = /*@__PURE__*/ createComponent<KupGridElement, KupGridEvents>({
    tagName: 'kup-grid',
...
export const KupGridRenderer = /*@__PURE__*/ createComponent<KupGridRendererElement, KupGridRendererEvents>({
...
export const KupHorizontalScroll = /*@__PURE__*/ createComponent<KupHorizontalScrollElement, KupHorizontalScrollEvents>({
...
export const KupIframe = /*@__PURE__*/ createComponent<KupIframeElement, KupIframeEvents>({
    tagName: 'kup-iframe',
...
export const KupImage = /*@__PURE__*/ createComponent<KupImageElement, KupImageEvents>({
    tagName: 'kup-image',
...
export const KupImageList = /*@__PURE__*/ createComponent<KupImageListElement, KupImageListEvents>({
...
type KupInputPanelEvents = { onKupInputPanelReady: EventName<KupInputPanelCustomEvent<KupEventPayload>> };

export const KupInputPanel = /*@__PURE__*/ createComponent<KupInputPanelElement, KupInputPanelEvents>({
    tagName: 'kup-input-panel',
    elementClass: KupInputPanelElement,
    react: React,
    events: { onKupInputPanelReady: 'kup-input-panel-ready' } as KupInputPanelEvents,
    defineCustomElement: defineKupInputPanel
});

type KupLazyEvents = { onKupLazyLoaded: EventName<KupLazyCustomEvent<KupEventPayload>> };

export const KupLazy = /*@__PURE__*/ createComponent<KupLazyElement, KupLazyEvents>({
    tagName: 'kup-lazy',
...
export const KupList = /*@__PURE__*/ createComponent<KupListElement, KupListEvents>({
    tagName: 'kup-list',
...
export const KupMagicBox = /*@__PURE__*/ createComponent<KupMagicBoxElement, KupMagicBoxEvents>({
...
export const KupNavBar = /*@__PURE__*/ createComponent<KupNavBarElement, KupNavBarEvents>({
    tagName: 'kup-nav-bar',
...
export const KupNumericPicker = /*@__PURE__*/ createComponent<KupNumericPickerElement, KupNumericPickerEvents>({
...
export const KupPdf = /*@__PURE__*/ createComponent<KupPdfElement, KupPdfEvents>({
    tagName: 'kup-pdf',
...
export const KupPhotoFrame = /*@__PURE__*/ createComponent<KupPhotoFrameElement, KupPhotoFrameEvents>({
...
export const KupPlanner = /*@__PURE__*/ createComponent<KupPlannerElement, KupPlannerEvents>({
    tagName: 'kup-planner',
...
export const KupPlannerRenderer = /*@__PURE__*/ createComponent<KupPlannerRendererElement, KupPlannerRendererEvents>({
...
export const KupProbe = /*@__PURE__*/ createComponent<KupProbeElement, KupProbeEvents>({
    tagName: 'kup-probe',
...
export const KupProgressBar = /*@__PURE__*/ createComponent<KupProgressBarElement, KupProgressBarEvents>({
...
export const KupQlik = /*@__PURE__*/ createComponent<KupQlikElement, KupQlikEvents>({
    tagName: 'kup-qlik',
...
export const KupRadio = /*@__PURE__*/ createComponent<KupRadioElement, KupRadioEvents>({
    tagName: 'kup-radio',
...
export const KupRating = /*@__PURE__*/ createComponent<KupRatingElement, KupRatingEvents>({
    tagName: 'kup-rating',
...
export const KupSnackbar = /*@__PURE__*/ createComponent<KupSnackbarElement, KupSnackbarEvents>({
...
export const KupSpinner = /*@__PURE__*/ createComponent<KupSpinnerElement, KupSpinnerEvents>({
    tagName: 'kup-spinner',
...
export const KupStandardTooltip = /*@__PURE__*/ createComponent<KupStandardTooltipElement, KupStandardTooltipEvents>({
...
export const KupSwitch = /*@__PURE__*/ createComponent<KupSwitchElement, KupSwitchEvents>({
    tagName: 'kup-switch',
...
export const KupSwitcher = /*@__PURE__*/ createComponent<KupSwitcherElement, KupSwitcherEvents>({
...
export const KupTabBar = /*@__PURE__*/ createComponent<KupTabBarElement, KupTabBarEvents>({
    tagName: 'kup-tab-bar',
...
export const KupTaskGantt = /*@__PURE__*/ createComponent<KupTaskGanttElement, KupTaskGanttEvents>({
...
export const KupTaskList = /*@__PURE__*/ createComponent<KupTaskListElement, KupTaskListEvents>({
...
export const KupTaskListHeader = /*@__PURE__*/ createComponent<KupTaskListHeaderElement, KupTaskListHeaderEvents>({
...
export const KupTaskListTable = /*@__PURE__*/ createComponent<KupTaskListTableElement, KupTaskListTableEvents>({
...
export const KupTextField = /*@__PURE__*/ createComponent<KupTextFieldElement, KupTextFieldEvents>({
...
export const KupTimePicker = /*@__PURE__*/ createComponent<KupTimePickerElement, KupTimePickerEvents>({
...
export const KupTooltip = /*@__PURE__*/ createComponent<KupTooltipElement, KupTooltipEvents>({
    tagName: 'kup-tooltip',
...
export const KupTree = /*@__PURE__*/ createComponent<KupTreeElement, KupTreeEvents>({
    tagName: 'kup-tree',
...
export const KupVerticalScroll = /*@__PURE__*/ createComponent<KupVerticalScrollElement, KupVerticalScrollEvents>({
