...
import {
    ...
    KupNavBarMode,
} from './components/kup-nav-bar/kup-nav-bar-declarations';
import {
...
declare global {
    ...
    interface HTMLKupBpmnElement
        extends Components.KupBpmn,
            HTMLStencilElement {}
    ...
    interface HTMLKupFieldElement
        extends Components.KupField,
            HTMLStencilElement {}
...
declare namespace LocalJSX {
    interface KupAutocomplete {
        ...
        'onKup-autocomplete-blur'?: (
            event: CustomEvent<KupAutocompleteEventPayload>
        ) => void;
        ...
        'onKup-autocomplete-filterchanged'?: (
            event: CustomEvent<kupAutocompleteFilterChangedEventPayload>
        ) => void;
        ...
        'onKup-autocomplete-textfieldsubmit'?: (
            event: CustomEvent<KupAutocompleteEventPayload>
        ) => void;
        /**
         * Sets how to return the selected item value. Suported values: "code", "description", "both".
    ...
    interface KupBadge {
        ...
        imageData?: {};
        'onKup-badge-click'?: (
            event: CustomEvent<KupBadgeEventPayload>
        ) => void;
        /**
         * The text displayed inside the badge.
         */
    ...
    interface KupBox {
        ...
        'onKup-box-autoselect'?: (
            event: CustomEvent<KupBoxAutoSelectEventPayload>
        ) => void;
        /**
         * Triggered when a box is clicked
         */
        'onKup-box-click'?: (
            event: CustomEvent<KupBoxClickEventPayload>
        ) => void;
        /**
         * Generic right click event on box.
         */
        'onKup-box-contextmenu'?: (
            event: CustomEvent<KupBoxContextMenuEventPayload>
        ) => void;
        ...
        'onKup-box-rowactionclick'?: (
            event: CustomEvent<KupBoxRowActionClickEventPayload>
        ) => void;
        /**
         * When the row menu action icon is click
         */
         ...
         */
        'onKup-box-selected'?: (
            event: CustomEvent<KupBoxSelectedEventPayload>
        ) => void;
        /**
         * Current page number
         */
    ...
    interface KupButton {
         ...
         */
        'onKup-button-blur'?: (
            event: CustomEvent<KupButtonClickEventPayload>
        ) => void;
        /**
    ...
    interface KupCheckbox {
         ...
         */
        'onKup-checkbox-blur'?: (
            event: CustomEvent<KupCheckboxEventPayload>
        ) => void;
        /**
    ...
    interface KupChip {
        ...
        'onKup-chip-iconclick'?: (
            event: CustomEvent<KupChipEventPayload>
        ) => void;
        /**
         * The type of chip. Available types: input, filter, choice or empty for default.
         * @default FChipType.STANDARD
    ...
    interface KupColorPicker {
        ...
        'onKup-colorpicker-change'?: (
            event: CustomEvent<KupColorPickerEventPayload>
        ) => void;
        'onKup-colorpicker-input'?: (
            event: CustomEvent<KupColorPickerEventPayload>
        ) => void;
        /**
         * When true, the component's text field will be replaced by a swatch.
    ...
    interface KupCombobox {
         ...
         */
        'onKup-combobox-blur'?: (
            event: CustomEvent<KupComboboxEventPayload>
        ) => void;
        ...
        'onKup-combobox-textfieldsubmit'?: (
            event: CustomEvent<KupComboboxEventPayload>
        ) => void;
        /**
         * Sets how to return the selected item value. Suported values: "code", "description", "both".
    ...
    interface KupDataTable {
         ...
         */
        'onKup-datatable-addcolumn'?: (
            event: CustomEvent<KupDatatableAddColumnEventPayload>
        ) => void;
        /**
         * When a row is auto selected via selectRow prop
         */
        'onKup-datatable-autorowselect'?: (
            event: CustomEvent<KupDatatableAutoRowSelectEventPayload>
        ) => void;
        'onKup-datatable-cellbuttonclick'?: (
            event: CustomEvent<KupDataTableCellButtonClickEventPayload>
        ) => void;
        /**
         * Emitted when a cell's data has been updated.
         */
        'onKup-datatable-cellupdate'?: (
            event: CustomEvent<KupDatatableCellUpdateEventPayload>
        ) => void;
        /**
         * Generic click event on data table.
         */
        'onKup-datatable-click'?: (
            event: CustomEvent<KupDatatableClickEventPayload>
        ) => void;
        /**
         * When the column menu is being opened/closed.
         */
        'onKup-datatable-columnmenu'?: (
            event: CustomEvent<KupDatatableColumnMenuEventPayload>
        ) => void;
        /**
        ...
        'onKup-datatable-didload'?: (
            event: CustomEvent<KupEventPayload>
        ) => void;
        /**
        ...
        'onKup-datatable-loadmoreclick'?: (
            event: CustomEvent<KupDatatableLoadMoreClickEventPayload>
        ) => void;
        /**
        ...
        'onKup-datatable-rowactionclick'?: (
            event: CustomEvent<KupDatatableRowActionClickEventPayload>
        ) => void;
        /**
        ...
        'onKup-datatable-textfieldinput'?: (
            event: CustomEvent<KupDataTableCellTextFieldInputEventPayload>
        ) => void;
        /**
         * Current selected page set on component load
         */
    ...
    interface KupDatePicker {
        ...
        'onKup-datepicker-blur'?: (
            event: CustomEvent<KupDatePickerEventPayload>
        ) => void;
    ...
    interface KupDropdownButton {
        ...
        'onKup-dropdownbutton-blur'?: (
            event: CustomEvent<KupDropdownButtonEventPayload>
        ) => void;
        /**
    ...
    interface KupField {
         ...
         */
        'onKup-field-change'?: (
            event: CustomEvent<KupFieldChangeEvent>
        ) => void;
        /**
         * Launched when the FLD values are confirmed and a submit event is triggered.
         */
        'onKup-field-submit'?: (
            event: CustomEvent<KupFieldSubmitEvent>
        ) => void;
        /**
         * Sets whether the submit button must be displayed or not.
         */
    ...
    interface KupForm {
        ...
        extraMessages?: FormMessage[];
        fields?: FormFields;
        'onKup-form-actionsubmitted'?: (
            event: CustomEvent<FormActionEventDetail>
        ) => void;
        'onKup-form-fieldblurred'?: (
            event: CustomEvent<FormFieldEventDetail>
        ) => void;
        'onKup-form-fieldchanged'?: (
            event: CustomEvent<FormFieldEventDetail>
        ) => void;
        'onKup-form-fieldfocused'?: (
            event: CustomEvent<FormFieldEventDetail>
        ) => void;
        refid?: string;
        searchCallBackOnFilterSubmitted?: (
    ...
    interface KupImage {
        ...
        isCanvas?: boolean;
        'onKup-image-click'?: (
            event: CustomEvent<KupImageClickEventPayload>
        ) => void;
        /**
         * The resource used to fetch the image.
         * @default null
    ...
    interface KupNavBar {
         ...
         */
        'onKup-navbar-menuitemclick'?: (
            event: CustomEvent<KupNavbarEventPayload>
        ) => void;
        /**
         * Triggered when a button is clicked.
         */
        'onKup-navbar-optionitemclick'?: (
            event: CustomEvent<KupNavbarEventPayload>
        ) => void;
    }
    interface KupPaginator {
         ...
         */
        'onKup-paginator-pagechanged'?: (
            event: CustomEvent<KupPaginatorPageChangedEventPayload>
        ) => void;
        /**
         * When the rows per page change
         */
        'onKup-paginator-rowsperpagechanged'?: (
            event: CustomEvent<KupPaginatorRowsPerPageChangedEventPayload>
        ) => void;
        perPage?: number;
        selectedPerPage?: number;
    }
    ...
    interface KupRadio {
         ...
         */
        'onKup-radio-change'?: (
            event: CustomEvent<KupRadioChangeEventPayload>
        ) => void;
        /**
         * Triggered when the input element gets focused.
         */
    ...
    interface KupRating {
        ...
        maxValue?: number;
        onKupRatingClick?: (
            event: CustomEvent<KupRatingClickEventPayload>
        ) => void;
        /**
         * Rated stars
         */
    ...
    interface KupSwitch {
         ...
         */
        'onKup-switch-blur'?: (
            event: CustomEvent<KupSwitchEventPayload>
        ) => void;
        /**
         * Triggered when the input element's value changes.
         */
    ...
    interface KupTabBar {
         ...
         */
        'onKup-tabbar-blur'?: (
            event: CustomEvent<KupTabBarEventPayload>
        ) => void;
        /**
         * Triggered when the tab is clicked.
         */
        'onKup-tabbar-click'?: (
            event: CustomEvent<KupTabBarClickEventPayload>
        ) => void;
        /**
    ...
    interface KupTimePicker {
        ...
        'onKup-timepicker-blur'?: (
            event: CustomEvent<KupTimePickerEventPayload>
        ) => void;
    ...
    interface KupTooltip {
         ...
         */
        loadTimeout?: number;
        'onKup-tooltip-actioncommandclick'?: (
            event: CustomEvent<KupTooltipActionCommandClickEventPayload>
        ) => void;
        'onKup-tooltip-defaultactionclick'?: (
            event: CustomEvent<KupTooltipDefaultEventPayload>
        ) => void;
        'onKup-tooltip-defaultoptionclick'?: (
            event: CustomEvent<KupTooltipDefaultEventPayload>
        ) => void;
        'onKup-tooltip-defaultpreviewclick'?: (
            event: CustomEvent<KupTooltipDefaultEventPayload>
        ) => void;
        'onKup-tooltip-loadcelloptions'?: (
            event: CustomEvent<KupTooltipLoadEventPayload>
        ) => void;
        'onKup-tooltip-loaddata'?: (
            event: CustomEvent<KupTooltipLoadEventPayload>
        ) => void;
        'onKup-tooltip-loaddetail'?: (
            event: CustomEvent<KupTooltipLoadEventPayload>
        ) => void;
        'onKup-tooltip-treedynamicmassexpansion'?: (
            event: CustomEvent<KupTooltipTreeDynamicMassExpansionEventPayload>
        ) => void;
        'onKup-tooltip-treenodebuttonclick'?: (
            event: CustomEvent<KupTooltipTreeNodeButtonClickEventPayload>
        ) => void;
        'onKup-tooltip-treenodedblclick'?: (
            event: CustomEvent<KupTooltipTreeNodeDblClickEventPayload>
        ) => void;
        'onKup-tooltip-treenodeexpand'?: (
            event: CustomEvent<KupTooltipTreeNodeExpandEventPayload>
        ) => void;
        /**
         * Fired when a node of the tree has been selected
         */
        'onKup-tooltip-treenodeselected'?: (
            event: CustomEvent<KupTooltipTreeNodeSelectedEventPayload>
        ) => void;
        /**
         * Owner of this tooltip
         */
    ...
    interface KupTree {
         ...
         * When 'add column' menu item is clicked
         */
        'onKup-tree-addcolumn'?: (
            event: CustomEvent<KupTreeAddColumnEventPayload>
        ) => void;
        ...
        'onKup-tree-columnmenu'?: (
            event: CustomEvent<KupTreeColumnMenuEventPayload>
        ) => void;
        /**
         * Generic right click event on tree.
         */
        'onKup-tree-contextmenu'?: (
            event: CustomEvent<KupTreeContextMenuEventPayload>
        ) => void;
        ...
        'onKup-tree-nodeexpand'?: (
            event: CustomEvent<KupTreeNodeExpandEventPayload>
        ) => void;
        /**
         * Fired when a node of the tree has been selected
         */
...
declare module '@stencil/core' {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            'kup-bpmn': LocalJSX.KupBpmn &
                JSXBase.HTMLAttributes<HTMLKupBpmnElement>;
            'kup-btn': LocalJSX.KupBtn &
                JSXBase.HTMLAttributes<HTMLKupBtnElement>;
            ...
            'kup-crud': LocalJSX.KupCrud &
                JSXBase.HTMLAttributes<HTMLKupCrudElement>;
            ...
            'kup-field': LocalJSX.KupField &
                JSXBase.HTMLAttributes<HTMLKupFieldElement>;
            ...
            'kup-image-button': LocalJSX.KupImageButton &
                JSXBase.HTMLAttributes<HTMLKupImageButtonElement>;
            'kup-layout': LocalJSX.KupLayout &
                JSXBase.HTMLAttributes<HTMLKupLayoutElement>;
            ...
            'kup-modal': LocalJSX.KupModal &
                JSXBase.HTMLAttributes<HTMLKupModalElement>;
            'kup-nav-bar': LocalJSX.KupNavBar &
                JSXBase.HTMLAttributes<HTMLKupNavBarElement>;
            'kup-paginator': LocalJSX.KupPaginator &
                JSXBase.HTMLAttributes<HTMLKupPaginatorElement>;
            ...
            'kup-search': LocalJSX.KupSearch &
                JSXBase.HTMLAttributes<HTMLKupSearchElement>;
            ...
            'kup-upload': LocalJSX.KupUpload &
                JSXBase.HTMLAttributes<HTMLKupUploadElement>;
        }
    }
}
