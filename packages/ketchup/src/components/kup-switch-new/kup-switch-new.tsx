...
import { FSwitch } from '../../f-components/f-switch-new/f-switch-new';
import { FSwitchProps } from '../../f-components/f-switch-new/f-switch-declarations-new';
import { GenericObject, KupComponent } from '../../types/GenericTypes';
import { KupSwitchProps } from './kup-switch-declaration-new';

@Component({
    tag: 'kup-switch-new',
    styleUrl: 'kup-switch-new.scss',
    shadow: true,
})
export class KupSwitchNew {
    /**
    ...
    private setEvents(): void {
        ...
        if (root) {
            const f: HTMLElement = root.querySelector('.f-switch-new-wrapper');
            if (f) {
