...
import { FCheckbox } from '../../f-components/f-checkbox-new/f-checkbox-new';
import { FCheckboxProps } from '../../f-components/f-checkbox-new/f-checkbox-declarations-new';
import { GenericObject, KupComponent } from '../../types/GenericTypes';
import { KupCheckboxProps } from './kup-checkbox-declarations-new';

@Component({
    tag: 'kup-checkbox-new',
    styleUrl: 'kup-checkbox-new.scss',
    shadow: true,
})
