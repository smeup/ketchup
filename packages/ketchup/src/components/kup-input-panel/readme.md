...
| `inputPanelPosition`       | `input-panel-position` | Creates a hidden submit button in order to submit the form with enter. | `"COLUMNS" \| "INLINE" \| "STRETCHED" \| "UPCOLUMNS" \| "UPINLINE" \| "WATERMARK"`                             | `undefined` |
