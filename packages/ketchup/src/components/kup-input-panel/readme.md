...
| `checkValidObjCallback`    | --                     | Sets the callback for valid the object when cell checkObject is true               | `(event: { obj: KupObj; value: string; currentState: KupInputPanelData; fun?: string; cellId?: string; }) => Promise<ValidCheckObjResponse>`                                                                 | `null`                                 |
...
| `fieldReset`               | `field-reset`          | When set to true, will render a reset button                                       | `boolean`                                                                                                                                                                                                    | `false`                                |
