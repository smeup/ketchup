...
| ----------------- | ----------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `calendarColumns` | --                | Sets the data to be used to render each event in the calendar              | `{ date: boolean; descr: boolean; end: boolean; icon: boolean; image: boolean; start: boolean; style: boolean; }`  | `{         [KupCalendarOptions.DATE]: false,         [KupCalendarOptions.DESCR]: false,         [KupCalendarOptions.END]: false,         [KupCalendarOptions.ICON]: false,         [KupCalendarOptions.IMAGE]: false,         [KupCalendarOptions.START]: false,         [KupCalendarOptions.STYLE]: false,     }` |
