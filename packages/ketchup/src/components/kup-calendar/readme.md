...
| `totals`           | `totals`             | Formula to calculate and display totals on each cell. Format: OPERATION(columnName) where OPERATION is SUM, AVG, or COUNT. Example: "SUM(amount)" or "AVG(hours)" or "COUNT(tasks)" | `string`                                                                                                           | `null`                                                                                                                                                                                                                                                                                        |
