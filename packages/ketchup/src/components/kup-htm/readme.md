...
| -------- | --------- | -------------------------------- | ------------- | ----------- |
| `data`   | --        | Data containing the url or html. | `KupDataCell` | `undefined` |
...
| --------------- | -------------------------------------- | ------------------------------ |
| `kup-htm-ready` | Triggered when the component is ready. | `CustomEvent<KupEventPayload>` |
...
graph TD;
  ...
  style kup-htm fill:#f9f,stroke:#333,stroke-width:4px
```
