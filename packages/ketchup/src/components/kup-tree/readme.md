...
| `density`                  | `density`               | The density of the rows, defaults at 'medium' and can also be set to 'dense' or 'wide'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `FCellPadding.DENSE \| FCellPadding.EXTRA_DENSE \| FCellPadding.MEDIUM \| FCellPadding.NONE \| FCellPadding.WIDE`                                                   | `FCellPadding.EXTRA_DENSE`       |
| `displayMode`              | `display-mode`          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `ItemsDisplayMode.CODE \| ItemsDisplayMode.CODE_AND_DESC \| ItemsDisplayMode.CODE_AND_DESC_ALIAS \| ItemsDisplayMode.DESCRIPTION \| ItemsDisplayMode.DESC_AND_CODE` | `ItemsDisplayMode.CODE_AND_DESC` |
...
| `treeHeight`               | `tree-height`           | The max-height of a tree                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `string`                                                                                                                                                            | `undefined`                      |
...
| `kup-tree-cell-click`           |                                                                                                                                   | `CustomEvent<FCellEventPayload>`                       |
