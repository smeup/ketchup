...
| `density`                  | `density`                     | The density of the rows, defaults at 'medium' and can also be set to 'dense' or 'wide'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `FCellPadding.DENSE \| FCellPadding.MEDIUM \| FCellPadding.WIDE`                  | `FCellPadding.MEDIUM`           |
