...
| `eventStart`           | --                     |             | `(action: GanttContentMoveAction, selectedTask: KupPlannerBarTask, event?: KeyboardEvent \| MouseEvent) => any`                           | `undefined` |
| `fontFamily`           | `font-family`          |             | `string`                                                                                                                                  | `''`        |
| `fontSize`             | `font-size`            |             | `string`                                                                                                                                  | `''`        |
| `ganttEvent`           | --                     |             | `{ changedTask?: KupPlannerBarTask; originalSelectedTask?: KupPlannerBarTask; action: GanttContentMoveAction; }`                          | `undefined` |
...
| `setGanttEvent`        | --                     |             | `(gantt: GanttEvent) => void`                                                                                                             | `undefined` |
