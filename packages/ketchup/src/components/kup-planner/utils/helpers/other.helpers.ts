import { KupPlannerBarTask, KupPlannerTask } from "../../kup-planner-declarations";
...
export function isBarTask(task: KupPlannerTask | KupPlannerBarTask): task is KupPlannerBarTask {
