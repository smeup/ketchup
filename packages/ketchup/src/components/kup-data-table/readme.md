...
| `onCellActionBuild`         | --                             | When set the new set of cellActions will be used insted of the default ones.                                                                                                                                                                | `(row: KupDataRow, column: KupDataColumn, cellActions: KupDataRowAction[]) => KupDataRowAction[]`                 | `undefined`                          |
