...
| `density`                   | `density`                      | The density of the rows, defaults at 'medium' and can be also set to 'large' or 'small'.                                                                                                                                       | `FCellPadding.DENSE \| FCellPadding.MEDIUM \| FCellPadding.WIDE`                                          | `FCellPadding.DENSE`                 |
