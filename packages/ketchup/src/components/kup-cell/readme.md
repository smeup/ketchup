...
| `density`        | `density`         | The density of the cell, defaults at 'dense' and can be also set to 'wide' or 'medium'. | `FCellPadding.DENSE \| FCellPadding.EXTRA_DENSE \| FCellPadding.MEDIUM \| FCellPadding.NONE \| FCellPadding.WIDE`                | `FCellPadding.NONE`             |
...
| `kup-cell-upload`       |             | `CustomEvent<KupFileUploadEventPayload>`      |
