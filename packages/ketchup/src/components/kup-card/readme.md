...
| `fullScreen`   | `full-screen`   | Defines whether the card is at full screen or not.                                                              | `boolean`                                                                                                                                                                    | `true`                           |
...
| `modal`        | --              | Set of options to display the dialog as a modal.                                                                | `KupCardModal`                                                                                                                                                               | `{ closeOnBackdropClick: true }` |
