...
| `data`        | --             | The actual data of the chart.                                                                                                                                          | `DataTable`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `null`                           |
...
| `mapName`     | `map-name`     | Choose which map you want to view, supported values: "europe", "africa", "asia", "oceania", "america", "italy" and "world".                                            | `KupEchartMaps.AFRICA \| KupEchartMaps.AMERICA \| KupEchartMaps.ASIA \| KupEchartMaps.EUROPE \| KupEchartMaps.ITALY \| KupEchartMaps.OCEANIA \| KupEchartMaps.WORLD`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `null`                           |
