...
import { FButton } from '../../f-components/f-button-new/f-button-new';
import {
    FButtonProps,
    FButtonStyling,
} from '../../f-components/f-button-new/f-button-declarations-new';
import { KupButtonProps } from './kup-button-declarations-new';
import { KupDebugCategory } from '../../utils/kup-debug/kup-debug-declarations';

@Component({
    tag: 'kup-button-new',
    styleUrl: 'kup-button-new.scss',
    shadow: true,
})
export class KupButtonNew {
    /**
    ...
    private setEvents(): void {
        ...
        if (root) {
            const f: HTMLElement = root.querySelector('.f-button-new-wrapper');
            if (f) {
