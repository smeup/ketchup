...
bottoniera1.addEventListener("kupBtnClick", (e) => {
    alert("Clicked button with index: [" + e.detail.id + "] smeupObject selected [" + JSON.stringify(e.detail.obj) + "]");
});

const bottoniera2 = document.getElementById('btn-verticale');
bottoniera2.columns = 1;
bottoniera2.data = defaultData;

const bottoniera3 = document.getElementById('btn-3-col');
bottoniera3.columns = 3;
bottoniera3.data = defaultData;

const bottoniera4 = document.getElementById('btn-collapsed');
