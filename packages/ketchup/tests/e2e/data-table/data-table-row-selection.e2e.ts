...
describe('row selection', () => {
    it.skip('auto select row', async () => {
        ...
        const kupAutoRowSelect = await element.spyOnEvent(
            'kup-datatable-autorowselect'
        );
    ...
    it.skip('single selection', async () => {
        ...
        const kupRowSelected = await element.spyOnEvent(
            'kup-datatable-rowselected'
        );
        element.setProperty('data', staticData);
        await page.waitForChanges();
    ...
    it.skip('multiple selection', async () => {
        ...
        const kupRowSelected = await dataTable.spyOnEvent(
            'kup-datatable-rowselected'
        );
