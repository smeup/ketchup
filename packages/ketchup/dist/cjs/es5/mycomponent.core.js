...
} var s = e.namespace || "mycomponent"; return q || (q = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Nn = !0; } }));
        ...
        catch (n) { } return 1 === t.G && n.Y && !e.shadowRoot && n.et(e, { mode: "open" }), r = { Tn: {} }, t.tn && Object.keys(t.tn).forEach(function (o) { (i = t.tn[o].rn) && (r.Tn[i] = n.zn(e, i)); }), r; }(n.Z, t, e)), n.ut(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { if (!n.ft && function (n, t) { for (; t;) {
        if (!n.Bn(t))
            return 9 !== n.Rn(t);
        t = n.Bn(t);
    } }(n.Z, t)) {
        ...
        var e = n.gn.get(t);
        e && e.componentDidUnload && e.componentDidUnload(), n.Z.cn(t), n.ct.delete(t), n.l && n.l.removeHost(t), [n.Mn, n.at, n.jn].forEach(function (n) { return n.delete(t); });
