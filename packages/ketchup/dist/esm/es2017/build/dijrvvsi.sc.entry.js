...
class KetchupTextInput {
    ...
    static get style() { return ".sc-ketchup-html-h{--htm_height:var(--kup-html_height,600px);--htm_width:var(--kup-html_width,100%);display:inline-block;width:100%}[is-button].sc-ketchup-html-h{display:inline-block;width:auto}.ketchup-frame.sc-ketchup-html{height:var(--htm_height);width:var(--htm_width)}"; }
}
