...
type KupObjectFieldEvents = {
    onKupObjectFieldSearch: EventName<KupObjectFieldCustomEvent<KupObjectFieldSearchPayload>>,
    onKupObjectFieldOpenSearchMenu: EventName<KupObjectFieldCustomEvent<KupObjectFieldOpenSearchMenuPayload>>,
    onKupObjectFieldSelectedMenuItem: EventName<KupObjectFieldCustomEvent<KupObjectFieldSelectedMenuItem>>
};
...
export const KupObjectField: StencilReactComponent<KupObjectFieldElement, KupObjectFieldEvents> = /*@__PURE__*/ createComponent<KupObjectFieldElement, KupObjectFieldEvents>({
    ...
    react: React,
    events: {
        onKupObjectFieldSearch: 'kup-object-field-search',
        onKupObjectFieldOpenSearchMenu: 'kup-object-field-open-search-menu',
        onKupObjectFieldSelectedMenuItem: 'kup-object-field-selected-menu-item'
    } as KupObjectFieldEvents,
