...
type KupFileUploadEvents = { onKupFileUploadReady: EventName<KupFileUploadCustomEvent<KupEventPayload>> };
...
export const KupFileUpload: StencilReactComponent<KupFileUploadElement, KupFileUploadEvents> = /*@__PURE__*/ createComponent<KupFileUploadElement, KupFileUploadEvents>({
    ...
    // @ts-ignore - React type of Stencil Output Target may differ from the React version used in the Nuxt.js project, this can be ignored.
    react: React,
    events: { onKupFileUploadReady: 'kup-file-upload-ready' } as KupFileUploadEvents,
